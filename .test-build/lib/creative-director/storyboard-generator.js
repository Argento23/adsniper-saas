...
exports.SLOT_OBJECTIVES = exports.SLOT_TITLES = void 0;
...
function buildPlan(duration, slots) {
...
function planStoryboard(duration) {
    if (duration === 15)
        return buildPlan(15, PLAN_15);
    if (duration === 20)
        return buildPlan(20, PLAN_20);
