...
function generateGenerativeSVG(prompt: string) {
    ...
    <svg width="1024" height="1024" xmlns="http://www.w3.org/2000/svg">
        ...
        <text x="50%" y="45%" font-family="'Inter', sans-serif" font-weight="900" font-size="80" fill="#ffffff" text-anchor="middle" style="text-shadow: 0px 10px 20px rgba(0,0,0,0.5);">
            ${safeText.toUpperCase()}
        </text>
        
        <text x="50%" y="55%" font-family="sans-serif" font-size="30" fill="rgba(255,255,255,0.8)" text-anchor="middle" letter-spacing="4">
            AI GENERATED VISUAL
        </text>
    </svg>`;
