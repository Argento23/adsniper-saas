...
const DEFAULT_PLANS: Record<PlanName, PlanConfig> = {
    ...
    pro: {
        name: 'pro',
        monthlyCredits: parseInt(process.env.PLAN_PRO_CREDITS || '40'),
        videoCreditCost: 0,
        imageProviders: ['bria'],
        allowsVideo: false,
        allowsImageUpload: true,
    ...
    studio: {
        name: 'studio',
        monthlyCredits: parseInt(process.env.PLAN_STUDIO_CREDITS || '100'),
        videoCreditCost: parseInt(process.env.PLAN_STUDIO_VIDEO_COST || '30'),
    ...
    agency: {
        name: 'agency',
        monthlyCredits: parseInt(process.env.PLAN_AGENCY_CREDITS || '600'),
        videoCreditCost: parseInt(process.env.PLAN_AGENCY_VIDEO_COST || '30'),
        imageProviders: ['bria', 'bria_inpaint'],
        allowsVideo: true,
        allowsImageUpload: true,
        marketprice: 149,
